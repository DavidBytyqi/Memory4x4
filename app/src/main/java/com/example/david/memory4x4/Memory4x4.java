package com.example.david.memory4x4;
...
public class Memory4x4 extends AppCompatActivity {
    ...
    private void checkEnd(){
        if(iv_11.getVisibility()==View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder=new AlertDialog.Builder(Memory4x4.this);
            alertDialogBuilder
                    ...
                    .setPositiveButton("New", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent=new Intent(getApplicationContext(),Memory4x4.class);
